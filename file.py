...
def open_file_bank(mode):
    return open('./_bank_file.dat', mode)
...
def add_bank_account(account_data):
    account_list[account_data[0]] = {
        ...
        'adm': True if account_data[4] == 'True' else ' False',
        }
...
def save_money_slips():
    ...
    lines[0] = ""
    for money_bill, values in money_slips.items():
        lines[0] += money_bill + '=' + str(values) + ';'
    lines[0] += '\n'
